package com.popular.broadcast.data.networking.repository

import com.popular.broadcast.data.networking.factory.NewsFactory
...
class NewsRepositoryImpl @Inject constructor(private val newsFactory: NewsFactory) :
    NewsRepository {
